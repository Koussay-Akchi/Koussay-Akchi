...
- [Sound-Grid](https://github.com/Koussay-Akchi/soundgrid): An interactive sound grid where users can compose simple musical patterns by toggling individual cells in a grid. made with React and Typescript, [live website](https://soundgrid.koussay.tn/)
- [Basic Minesweeper](https://github.com/Koussay-Akchi/minesweeper): Minesweeper clone made with React and vanilla JavaScript, [live website](https://minesweeper.koussay.tn/)
